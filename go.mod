...
require (
	...
	istio.io/istio v0.0.0-20240710072923-f4b1a1f362f3
	k8s.io/api v0.30.2
...
require (
	...
	github.com/envoyproxy/go-control-plane v0.12.1-0.20240628042141-fb8275a6aab4 // indirect
	...
	istio.io/client-go v1.22.0-alpha.1.0.20240709220522-6a1c4585544d // indirect
